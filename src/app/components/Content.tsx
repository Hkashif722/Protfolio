        ...
        <div className=" mx-32 ">
          ...
          <div className="flex p-2">
            <ul className="flex mx-auto border border-gray-500 rounded-xl hover:cursor-pointer " >
                ...
                <li className=" hover:bg-white  hover:text-black border-y p-2 font-extrabold  ">Experience</li>
        ...
        <div className="xl:grid xl:grid-cols-2 justify-center gap-3">
            {
                [1,2,3,4,5].map(element => {
                    return (<div key={element} className="flex mb-3 xl:mb-0 justify-between items-center p-3 h-full w-full bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 border border-gray-100">
                        <div>
